...
export class AnnotationComponent extends BaseComponent<AnnotationProps> {
  validateProps(): void {
  ...
  calculateMinDimensions(theme: ThemeVariables): Dimension {
    ...
    let maxChars = Math.max(title.length, '«annotation»'.length);
