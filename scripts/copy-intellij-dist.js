...
const destDir = path.join(__dirname, '../intellij-extension/src/main/resources/webview-dist');
...
try {
  ...
  console.log('Built assets copied successfully to IntelliJ extension resources.');
} catch (err) {
